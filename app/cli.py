...
def generate(
    ...
    primary_vnet_cidr: str = typer.Option("10.10.0.0/16", "--primary-vnet", help="Primary VNet CIDR"),
    secondary_vnet_cidr: Optional[str] = typer.Option(None, "--secondary-vnet", help="Secondary VNet CIDR (for GZRS/Failover)"),
    ...
    github_org_or_user: str = typer.Option(..., "--github-user", "-u", help="GitHub username or organization"),
    github_repo_name: str = typer.Option(..., "--github-repo", help="Target GitHub repository name"),
